    ...
    <div className="w-[375px] h-[812px] bg-slate-100 ">
      <div className=" pl-[15px] flex-col mt-12 ">
        <div className=" mt-[20px] ">
          ...
          <span className=" text-[#004DFF] ">Custom Seed Phrase?</span>
        </div>
        <Row>
          {listData24.length !== 0 &&
      ...
      <div className=" bg-white h-[170px] flex flex-col justify-center ">
        ...
        <div className="flex justify-evenly items-center mt-6 ">
          <div
            className=" w-[101px] h-[56px] border-[#EDEEF0] 
            border-[1px] rounded-md flex justify-center items-center"
          >
            <span className=" text-[#D3D7DB] font-bold ">BACK</span>
          </div>
          <div
            className="ml-[18px] bg-[#004DFF] w-[218px]
...
export default CustomSeedPhrase;
